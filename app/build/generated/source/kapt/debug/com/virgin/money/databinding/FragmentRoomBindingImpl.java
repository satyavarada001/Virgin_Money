...
public class FragmentRoomBindingImpl extends FragmentRoomBinding  {
    ...
    public FragmentRoomBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 3, sIncludes, sViewsWithIds));
    }
    private FragmentRoomBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.virgin.money.ui.room.RoomViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.virgin.money.ui.room.RoomViewModel ViewModel) {
    ...
    protected void executeBindings() {
        ...
        com.virgin.money.ui.room.RoomViewModel viewModel = mViewModel;
